...
describe("Authentication", function () {
    ...
    before(function (done) {
        db.connect({db: "membership"}, function (err, db) {
            ...
            // Delete all users and add new user
            // After each next step will using user created at below
    ...
    describe("a valid login", function () {
        ...
        it("returns a message saying 'Welcome!'", function () {
